var GIST_CONTENT = "https://gist.github.com/raw/7438be92500391a7868f/c60093154383f2810fb071a6603fb532116e8840/github.gist.content.xml";
var GIST_META = "https://gist.github.com/raw/c1d46486dd9a37fc617f/b7ef7f4ba5fa178b5e562cbd88f2093f6b34a2b9/github.gist.list.xml"
...
var list = exports.list = function list(options, success, error) {
    ...
    request({
        ...
        error: function requestError(response) {
            try {
                result.error = JSON.parse(response.responseText).error;
            } catch(e) {
...
var write = exports.write = function write(files, options, success, error) {
    ...
    var query = ((options.repo) ? // update
        ...
        : // insert
            query = _(WRITE, TABLE_CONTENT, options.user, options.token, names.join(SEPARATOR),
...
var read = exports.read = function read(repo, options, success, error) {
    var result = {};
    request({
        url: "https://gist.github.com/" + repo + ".txt",
        method: "POST",
        data: options,
        success: function requestSuccess(response) {
